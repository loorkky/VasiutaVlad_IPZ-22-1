...
SELECT *
FROM Employees
WHERE Salary > 2500 AND Position = 'Програміст';
...
SELECT *
FROM Employees
WHERE Position = 'Менеджер з продажу' AND Salary < 3000;

SELECT *
FROM Employees
WHERE Position = 'Менеджер з продажу' OR Position = 'Головний бухгалтер';
